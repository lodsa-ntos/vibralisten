  ...
  return (
    <div className="container-auth-layout">
      ...
      <div className="overlay-box">
        <h3>Discover new music. Join VibraListen now!</h3>
        <div className="overlay-content">
          ...
          <div className="overlay-content-login-api">
            <div className="login-api">
              <button className="spotify"> <FaSpotify size={20} style={{ marginRight: "10px" }}/> Sign up with Spotify</button>
            </div>
            <div className="login-api">
              <button className="deezer"> <FaDeezer size={20} style={{ marginRight: "10px" }} /> Sign up with Deezer</button>
            </div>
            <div className="login-api">
              <button className="google"> <FcGoogle size={20} style={{ marginRight: "10px" }} /> Sign up with Google</button>
            </div>
          </div>
